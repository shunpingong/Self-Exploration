# Nemotron Locally Hosted FastAPI Backend

This project is a minimal FastAPI service that wraps NVIDIA Nemotron through the OpenAI-compatible NVIDIA API.
...
4. Copy `.env.example` to `.env` and set the NVIDIA API values.
